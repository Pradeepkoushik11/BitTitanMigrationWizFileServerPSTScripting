...
Write-Host
Write-Host -ForegroundColor Magenta "             BitTitan File Server to OneDrive For Business migration project creation tool."
Write-Host
...
foreach ($user in $users) {      
    ...
    $ProjectName = "FS-OD4B-$($user.SourceFolder.ToLower())" #-$(Get-Date -Format yyyyMMddHHmm)
    $ProjectType = "Storage"   
