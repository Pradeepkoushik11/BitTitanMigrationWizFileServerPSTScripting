...
Write-Host
Write-Host -ForegroundColor Magenta "             BitTitan File Server to OneDrive For Business migration project creation + start migrations tool."
Write-Host
...
foreach ($user in $users) {
    .\Start-MWMigrationsFromCSVFileHCLVersion.ps1 -BitTitanWorkGroupId $BitTitanWorkGroupId `
        ...
        -ProjectsCSVFilePath $(    .\Create-FileServerToOD4BMWMigrationProjectsHCLVersion.ps1 -WorkingDirectory 'C:\Scripts' `
    ...
    .\Start-MWMigrationsFromCSVFileHCLVersion.ps1 -BitTitanWorkGroupId $BitTitanWorkGroupId `
        ...
        -BitTitanMigrationScope $BitTitanMigrationScope `
        -BitTitanMigrationType $BitTitanMigrationType `
        -ProjectsCSVFilePath $(    .\Create-PstToMailboxMWMigrationProjectsHCLVersion.ps1 -WorkingDirectory 'C:\Scripts' `
            -downloadLatestVersion $downloadLatestVersion `
            -BitTitanAzureDatacenter $BitTitanAzureDatacenter `
            -BitTitanWorkgroupId $BitTitanWorkgroupId `
            -BitTitanCustomerId $BitTitanCustomerId `
